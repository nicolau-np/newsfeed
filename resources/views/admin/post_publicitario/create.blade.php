...
<div class="form">
    ...
    <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;</em> {{session('success')}} <a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>
     @endif
     {{Form::open(['method'=>"post", 'name'=>"formBlog", 'url'=>"/admin/publicidades/store", 'enctype'=>"multipart/form-data"])}}
    @csrf
        <fieldset>
            <legend>Dados</legend>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {{Form::text('link', null, ['placeholder'=>"Link acesso a pagina", 'class'=>"form-control"])}}
                        @if($errors->has('link'))
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {{Form::text('linkImg', null, ['placeholder'=>"Link da Foto", 'class'=>"form-control"])}}

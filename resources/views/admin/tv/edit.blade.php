...
<div class="form">
    ...
    <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-check">&nbsp;</em> {{session('success')}} <a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>
     @endif
     {{Form::open(['method'=>"put", 'name'=>"formBlog", 'url'=>"/admin/tvonline/update/{$getCanal->id}", 'enctype'=>"multipart/form-data"])}}
    @csrf
        <fieldset>
            <legend>Dados</legend>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {{Form::text('canal', $getCanal->canal, ['placeholder'=>"Canal", 'class'=>"form-control"])}}
                        @if($errors->has('canal'))
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('link', $getCanal->link, ['class'=>"form-control", 'placeholder'=>"Link"]) }}
                    @if($errors->has('link'))
                ...
                <div class="col-md-3">
                    ...
                    {{ Form::text('img', $getCanal->img, ['class'=>"form-control",  'placeholder'=>"Imagem"]) }}
                    @if($errors->has('img'))
                ...
                <div class="col-md-3">
                    <div class="form-group">
                       ...
                       {{ Form::select('estado', [
                           'on'=>"on",
                           'off'=>"off"
                       ], $getCanal->estado, ['placeholder'=>"Estado", 'class'=>"form-control"]) }}
